...
class ApiClient
{
     ...
     */
    public function __construct($partnerId=null, $signatureKey=null, \Com\Alacriti\Checkout\Client\Configuration $config = null )
    {
        if ($config === null) {
    ...
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        $hmac_sha_256_hash = AuthenticationUtil::computeHMACSHA256HASH($url, $method, $queryParams,
            $postData, $headerParams,$this->signatureKey);

        $autherizationHeader = APIConstants::OPCO_HASH_ALGORITHM .
            " Credential=" . $this->partnerId . ",Signature=" . $hmac_sha_256_hash;
        ...
        if ($response_info['http_code'] === 0) {
            ...
            if (json_last_error() > 0) { // if response is a string
                ...
                if(isset($data) ? $data->errors != null || $data->id == null : false){
                ...
                } elseif(isset($data) ? $data->errors == null && $data->id == null : false){
                    $response_info['http_code'] = 400;
